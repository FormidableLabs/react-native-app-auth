...
public class RNAppAuthModule extends ReactContextBaseJavaModulw implements ActivityEventListener  {
...
@ReactMethod
public void authorize(String issuer, final String redirectUrl, final String clientId, final Promise promise) {
    ...
    new AuthorizationServiceConfiguration.RetrieveConfigurationCallback() {
      public void onFetchConfigurationCompleted(
        ...
        AuthorizationRequest authRequest = authRequestBuilder
              .setScope("openid email profile") // TODO: should be customizable?
              .build();
...
@ReactMethod
public void refresh(String issuer, final String redirectUrl, final String clientId, final String refreshToken, final Promise promise) {
  final Context context = this.reactContext;

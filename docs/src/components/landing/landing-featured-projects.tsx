...
export const LandingFeaturedProjects = ({
  ...
  <div className="flex flex-col text-left mx-16 lg:mx-32 xl:mx-64 mt-12 pb-12">
    {showDivider && <Divider />}
      ...
      {projects.map(({ name, link, description, title }) => (
        ...
        >
          ...
          <span className="flex flex-col col-span-1 lg:col-span-2">
            <span className="text-xl font-semibold capitalize">{title || name}</span>
    ...
    <div className="my-8 pt-8 align-center">
      <NFLinkButton link="https://commerce.nearform.com/open-source" text="View All Projects" />
    </div>
  </div>
);
